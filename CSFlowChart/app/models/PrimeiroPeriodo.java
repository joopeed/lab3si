...
public class PrimeiroPeriodo implements Periodo {
	...
	public PrimeiroPeriodo() {
		...
		disciplinas.add(new Disciplina("Cálculo Diferencial e Integral I", 4, preRequisitos,"0"));
		disciplinas.add(new Disciplina("Álgebra Vetorial e Geometria Analítica", 4, preRequisitos,"0"));
		disciplinas.add(new Disciplina("Leitura e Produção de Textos", 4, preRequisitos,"0"));
		disciplinas.add(new Disciplina("Programação I", 4, preRequisitos,"0"));
		disciplinas.add(new Disciplina("Introdução à Computação", 4, preRequisitos,"0"));
		disciplinas.add(new Disciplina("Laboratório de Programação I", 4, preRequisitos,"0"));
	}
